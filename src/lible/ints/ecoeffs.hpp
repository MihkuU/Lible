...
namespace lible
{
    namespace ints
    {
         ...
         *
         */
        void ecoeffsKernel(const double one_o_2a, const int l, vec2d &ecoeffs);
        ...
        void calcECoeffs(const double a, const int l, vec2d &ecoeffs_x, vec2d &ecoeffs_y,
                         vec2d &ecoeffs_z);
         ...
         */
        void calcECoeffs(const int la, const int lb, const ShellPairData &sp_data,
                         std::vector<std::vector<vec4d>> &ecoeffs_out);

        /**
         *
         */
        void calcECoeffsSpherical(const int la, const int lb, const ShellPairData &sp_data,
         ...
         *
         */
        void calcECoeffsSpherical(const int l, const ShellData &sh_data,
                                  std::vector<double> &ecoeffs_out);
