...
{
    /// Calculates the Hermite integrals as a matrix, R(t + t', u + u', v + v') -> R(tuv, t'u'v').
    ...
    /// each incremented Cartesian direction, (t + 1, u, v), (t, u + 1, v) and (t, u, v + 1).
    ...
    /// incremented Cartesian direction, (t + 2, u, v), (t + 1, u + 1, v), (t + 1, u, v + 1),
    /// (t, u + 2, v), (t, u + 1, v + 1) and (t, u + 2, v + 2).
    ...
    /// the Cartesian directions (t + 1, u, v), (t, u + 1, v) (t, u, v + 1) and (t, u, v).
    ...
    ///
    std::vector<double> calcRInts_ERI3D2(int l, double alpha, double fac, const double *fnx,
                                         const double *xyz_pc,
                                         const std::vector<std::array<int, 3>> &hermite_idxs_bra,
                                         const std::vector<std::array<int, 3>> &hermite_idxs_ket);
                          ...
                          const double *xyz_pc, double *rints)
    {
        ...
        std::array<double, buff_size> rints_buff{};
        calcRInts<labc + 2>(alpha, fnx, xyz_pc, &rints_buff[0]);
