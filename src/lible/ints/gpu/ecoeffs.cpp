// #include <lible/ints/gpu/ecoeffs.hpp>
...
// {
//     // extern "C" __device__ int idxE(int d3, int d23, int i, int j, int t, int pos);
//     // extern "C" __device__ int dimCartIdxs(int l);
...
//     // __device__ void calcECoeffsX(const int la, const int lb, const int pos, const double PA,
...
//     //     E[idxE(d3, d23, 0, 0, 0, pos)] = 0;

//     //     for (int i = 1; i <= la; i++)
//     //     {
//     //         E[idxE(d3, d23, i, 0, 0, pos)] = PA * E[idxE(d3, d23, i - 1, 0, 0, pos)] +
//     //                                          E[idxE(d3, d23, i - 1, 0, 1, pos)];

//     //         for (int t = 1; t < i; t++)
//     //             E[idxE(d3, d23, i, 0, t, pos)] = one_o_2p * E[idxE(d3, d23, i - 1, 0, t - 1, pos)] +
//     //                                              PA * E[idxE(d3, d23, i - 1, 0, t, pos)] +
//     //                                              (t + 1) * E[idxE(d3, d23, i - 1, 0, t + 1, pos)];

//     //         E[idxE(d3, d23, i, 0, i, pos)] = one_o_2p * E[idxE(d3, d23, i - 1, 0, i - 1, pos)] +
//     //                                          PA * E[idxE(d3, d23, i - 1, 0, i, pos)];
//     //     }

//     //     for (int j = 1; j <= lb; j++)
//     //         for (int i = 0; i <= la; i++)
//     //         {
//     //             E[idxE(d3, d23, i, j, 0, pos)] = PB * E[idxE(d3, d23, i, j - 1, 0, pos)] +
//     //                                              E[idxE(d3, d23, i, j - 1, 1, pos)];

//     //             for (int t = 1; t < i + j; t++)
//     //                 E[idxE(d3, d23, i, j, t, pos)] = one_o_2p * E[idxE(d3, d23, i, j - 1, t - 1, pos)] +
//     //                                                  PB * E[idxE(d3, d23, i, j - 1, t, pos)] +
//     //                                                  (t + 1) * E[idxE(d3, d23, i, j - 1, t + 1, pos)];

//     //             E[idxE(d3, d23, i, j, i + j, pos)] = one_o_2p * E[idxE(d3, d23, i, j - 1, i + j - 1, pos)] +
//     //                                                  PB * E[idxE(d3, d23, i, j - 1, i + j, pos)];
//     //         }
//     // }
