...
template<>
void lible::ints::calcRInts_ERI_new<2, 0>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 4) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[6];
    rints_out[(ofs_row + 5) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[7];
    rints_out[(ofs_row + 6) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[8];
    rints_out[(ofs_row + 7) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[9];
    rints_out[(ofs_row + 8) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[10];
    rints_out[(ofs_row + 9) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[11];
}
...
template void lible::ints::calcRInts_ERI2D1<2, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<2, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<2, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<2, 0>(const double alpha, const double fac, const double *fnx,
