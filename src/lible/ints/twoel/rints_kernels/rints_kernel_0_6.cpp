...
template<>
void lible::ints::calcRInts_ERI_new<0, 6>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 56)] = 1.0 * fac * rints_buff[62];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 57)] = 1.0 * fac * rints_buff[63];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 58)] = 1.0 * fac * rints_buff[64];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 59)] = 1.0 * fac * rints_buff[65];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 60)] = 1.0 * fac * rints_buff[66];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 61)] = 1.0 * fac * rints_buff[67];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 62)] = 1.0 * fac * rints_buff[68];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 63)] = 1.0 * fac * rints_buff[69];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 64)] = 1.0 * fac * rints_buff[70];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 65)] = 1.0 * fac * rints_buff[71];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 66)] = 1.0 * fac * rints_buff[72];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 67)] = 1.0 * fac * rints_buff[73];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 68)] = 1.0 * fac * rints_buff[74];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 69)] = 1.0 * fac * rints_buff[75];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 70)] = 1.0 * fac * rints_buff[76];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 71)] = 1.0 * fac * rints_buff[77];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 72)] = 1.0 * fac * rints_buff[78];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 73)] = 1.0 * fac * rints_buff[79];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 74)] = 1.0 * fac * rints_buff[80];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 75)] = 1.0 * fac * rints_buff[81];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 76)] = 1.0 * fac * rints_buff[82];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 77)] = 1.0 * fac * rints_buff[83];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 78)] = 1.0 * fac * rints_buff[84];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 79)] = 1.0 * fac * rints_buff[85];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 80)] = 1.0 * fac * rints_buff[86];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 81)] = 1.0 * fac * rints_buff[87];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 82)] = 1.0 * fac * rints_buff[88];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 83)] = 1.0 * fac * rints_buff[89];
}
...
template<>
void calcRInts_ERI<0, 6>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI2_deriv1<0, 6>(const double, const double, const double*, const double*, double*);
template void lible::ints::calcRInts_ERI2D1<0, 6>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<0, 6>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<0, 6>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<0, 6>(const double alpha, const double fac, const double *fnx,
