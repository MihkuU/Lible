...
template void lible::ints::calcRInts_ERI2D2<1, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);
...
template void lible::ints::calcRInts_ERISOC<1, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);
