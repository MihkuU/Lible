...
template<>
void lible::ints::calcRInts_ERI_new<3, 1>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 10) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[24];
    rints_out[(ofs_row + 11) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[25];
    rints_out[(ofs_row + 12) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[26];
    rints_out[(ofs_row + 13) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[27];
    rints_out[(ofs_row + 14) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[28];
    rints_out[(ofs_row + 15) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[29];
    rints_out[(ofs_row + 16) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[30];
    rints_out[(ofs_row + 17) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[31];
    rints_out[(ofs_row + 18) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[32];
    rints_out[(ofs_row + 19) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[33];
    ...
    rints_out[(ofs_row + 10) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[25];
    rints_out[(ofs_row + 11) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[27];
    rints_out[(ofs_row + 12) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[28];
    rints_out[(ofs_row + 13) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[30];
    rints_out[(ofs_row + 14) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[31];
    rints_out[(ofs_row + 15) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[32];
    rints_out[(ofs_row + 16) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[34];
    rints_out[(ofs_row + 17) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[35];
    rints_out[(ofs_row + 18) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[36];
    rints_out[(ofs_row + 19) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[37];
    ...
    rints_out[(ofs_row + 10) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[26];
    rints_out[(ofs_row + 11) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[28];
    rints_out[(ofs_row + 12) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[29];
    rints_out[(ofs_row + 13) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[31];
    rints_out[(ofs_row + 14) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[32];
    rints_out[(ofs_row + 15) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[33];
    rints_out[(ofs_row + 16) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[35];
    rints_out[(ofs_row + 17) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[36];
    rints_out[(ofs_row + 18) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[37];
    rints_out[(ofs_row + 19) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[38];
}
...
template void lible::ints::calcRInts_ERI2D1<3, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<3, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<3, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<3, 1>(const double alpha, const double fac, const double *fnx,
