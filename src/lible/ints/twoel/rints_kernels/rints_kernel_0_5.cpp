...
template<>
void lible::ints::calcRInts_ERI_new<0, 5>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 35)] = -1.0 * fac * rints_buff[40];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 36)] = -1.0 * fac * rints_buff[41];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 37)] = -1.0 * fac * rints_buff[42];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 38)] = -1.0 * fac * rints_buff[43];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 39)] = -1.0 * fac * rints_buff[44];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 40)] = -1.0 * fac * rints_buff[45];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 41)] = -1.0 * fac * rints_buff[46];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 42)] = -1.0 * fac * rints_buff[47];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 43)] = -1.0 * fac * rints_buff[48];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 44)] = -1.0 * fac * rints_buff[49];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 45)] = -1.0 * fac * rints_buff[50];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 46)] = -1.0 * fac * rints_buff[51];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 47)] = -1.0 * fac * rints_buff[52];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 48)] = -1.0 * fac * rints_buff[53];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 49)] = -1.0 * fac * rints_buff[54];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 50)] = -1.0 * fac * rints_buff[55];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 51)] = -1.0 * fac * rints_buff[56];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 52)] = -1.0 * fac * rints_buff[57];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 53)] = -1.0 * fac * rints_buff[58];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 54)] = -1.0 * fac * rints_buff[59];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 55)] = -1.0 * fac * rints_buff[60];
}
...
template void lible::ints::calcRInts_ERI2_deriv1<0, 5>(const double, const double, const double*, const double*, double*);
...
template void lible::ints::calcRInts_ERI4D1<0, 5>(const double alpha, const double fac, const double *fnx,
