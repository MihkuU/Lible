...
template<>
void lible::ints::calcRInts_ERI_new<3, 0>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 10) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[13];
    rints_out[(ofs_row + 11) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[14];
    rints_out[(ofs_row + 12) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[15];
    rints_out[(ofs_row + 13) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[16];
    rints_out[(ofs_row + 14) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[17];
    rints_out[(ofs_row + 15) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[18];
    rints_out[(ofs_row + 16) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[19];
    rints_out[(ofs_row + 17) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[20];
    rints_out[(ofs_row + 18) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[21];
    rints_out[(ofs_row + 19) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[22];
}
...
template<>
void calcRInts_ERI<3, 0>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI2D2<3, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);
