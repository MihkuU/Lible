...
template<>
void lible::ints::calcRInts_ERI_new<5, 0>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 4) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[9];
    rints_out[(ofs_row + 5) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[10];
    rints_out[(ofs_row + 6) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[11];
    rints_out[(ofs_row + 7) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[12];
    rints_out[(ofs_row + 8) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[13];
    rints_out[(ofs_row + 9) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[14];
    rints_out[(ofs_row + 10) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[15];
    rints_out[(ofs_row + 11) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[16];
    rints_out[(ofs_row + 12) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[17];
    rints_out[(ofs_row + 13) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[18];
    rints_out[(ofs_row + 14) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[19];
    rints_out[(ofs_row + 15) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[20];
    rints_out[(ofs_row + 16) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[21];
    rints_out[(ofs_row + 17) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[22];
    rints_out[(ofs_row + 18) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[23];
    rints_out[(ofs_row + 19) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[24];
    rints_out[(ofs_row + 20) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[25];
    rints_out[(ofs_row + 21) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[26];
    rints_out[(ofs_row + 22) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[27];
    rints_out[(ofs_row + 23) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[28];
    rints_out[(ofs_row + 24) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[29];
    rints_out[(ofs_row + 25) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[30];
    rints_out[(ofs_row + 26) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[31];
    rints_out[(ofs_row + 27) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[32];
    rints_out[(ofs_row + 28) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[33];
    rints_out[(ofs_row + 29) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[34];
    rints_out[(ofs_row + 30) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[35];
    rints_out[(ofs_row + 31) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[36];
    rints_out[(ofs_row + 32) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[37];
    rints_out[(ofs_row + 33) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[38];
    rints_out[(ofs_row + 34) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[39];
    rints_out[(ofs_row + 35) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[40];
    rints_out[(ofs_row + 36) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[41];
    rints_out[(ofs_row + 37) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[42];
    rints_out[(ofs_row + 38) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[43];
    rints_out[(ofs_row + 39) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[44];
    rints_out[(ofs_row + 40) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[45];
    rints_out[(ofs_row + 41) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[46];
    rints_out[(ofs_row + 42) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[47];
    rints_out[(ofs_row + 43) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[48];
    rints_out[(ofs_row + 44) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[49];
    rints_out[(ofs_row + 45) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[50];
    rints_out[(ofs_row + 46) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[51];
    rints_out[(ofs_row + 47) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[52];
    rints_out[(ofs_row + 48) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[53];
    rints_out[(ofs_row + 49) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[54];
    rints_out[(ofs_row + 50) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[55];
    rints_out[(ofs_row + 51) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[56];
    rints_out[(ofs_row + 52) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[57];
    rints_out[(ofs_row + 53) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[58];
    rints_out[(ofs_row + 54) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[59];
    rints_out[(ofs_row + 55) * n_cols + (ofs_col + 0)] = 1.0 * fac * rints_buff[60];
}
...
template<>
void calcRInts_ERI<5, 0>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI2_deriv1<5, 0>(const double, const double, const double*, const double*, double*);
template void lible::ints::calcRInts_ERI2D1<5, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<5, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<5, 0>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<5, 0>(const double alpha, const double fac, const double *fnx,
