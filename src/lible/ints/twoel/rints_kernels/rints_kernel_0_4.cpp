...
template<>
void lible::ints::calcRInts_ERI_new<0, 4>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 20)] = 1.0 * fac * rints_buff[24];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 21)] = 1.0 * fac * rints_buff[25];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 22)] = 1.0 * fac * rints_buff[26];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 23)] = 1.0 * fac * rints_buff[27];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 24)] = 1.0 * fac * rints_buff[28];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 25)] = 1.0 * fac * rints_buff[29];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 26)] = 1.0 * fac * rints_buff[30];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 27)] = 1.0 * fac * rints_buff[31];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 28)] = 1.0 * fac * rints_buff[32];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 29)] = 1.0 * fac * rints_buff[33];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 30)] = 1.0 * fac * rints_buff[34];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 31)] = 1.0 * fac * rints_buff[35];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 32)] = 1.0 * fac * rints_buff[36];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 33)] = 1.0 * fac * rints_buff[37];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 34)] = 1.0 * fac * rints_buff[38];
}
...
template<>
void calcRInts_ERI<0, 4>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI2_deriv1<0, 4>(const double, const double, const double*, const double*, double*);
template void lible::ints::calcRInts_ERI2D1<0, 4>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<0, 4>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<0, 4>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<0, 4>(const double alpha, const double fac, const double *fnx,
