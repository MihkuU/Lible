...
template<>
void lible::ints::calcRInts_ERI_new<0, 0>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI4D1<0, 0>(const double alpha, const double fac, const double *fnx,
