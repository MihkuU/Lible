...
template<>
void lible::ints::calcRInts_ERI_new<1, 2>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 4)] = 1.0 * fac * rints_buff[7];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 4)] = 1.0 * fac * rints_buff[13];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 4)] = 1.0 * fac * rints_buff[14];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 4)] = 1.0 * fac * rints_buff[15];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 5)] = 1.0 * fac * rints_buff[8];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 5)] = 1.0 * fac * rints_buff[14];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 5)] = 1.0 * fac * rints_buff[16];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 5)] = 1.0 * fac * rints_buff[17];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 6)] = 1.0 * fac * rints_buff[9];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 6)] = 1.0 * fac * rints_buff[15];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 6)] = 1.0 * fac * rints_buff[17];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 6)] = 1.0 * fac * rints_buff[18];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 7)] = 1.0 * fac * rints_buff[10];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 7)] = 1.0 * fac * rints_buff[16];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 7)] = 1.0 * fac * rints_buff[19];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 7)] = 1.0 * fac * rints_buff[20];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 8)] = 1.0 * fac * rints_buff[11];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 8)] = 1.0 * fac * rints_buff[17];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 8)] = 1.0 * fac * rints_buff[20];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 8)] = 1.0 * fac * rints_buff[21];
    rints_out[(ofs_row + 0) * n_cols + (ofs_col + 9)] = 1.0 * fac * rints_buff[12];
    rints_out[(ofs_row + 1) * n_cols + (ofs_col + 9)] = 1.0 * fac * rints_buff[18];
    rints_out[(ofs_row + 2) * n_cols + (ofs_col + 9)] = 1.0 * fac * rints_buff[21];
    rints_out[(ofs_row + 3) * n_cols + (ofs_col + 9)] = 1.0 * fac * rints_buff[22];
}
...
template<>
void calcRInts_ERI<1, 2>(const double alpha, const double fac, const double *fnx,
                         const double *xyz_ab, double *rints_out)
{
    ...
    rints_out[10] = 1.0 * fac * rints_buff[4];
    rints_out[20] = 1.0 * fac * rints_buff[5];
    rints_out[30] = 1.0 * fac * rints_buff[6];
    rints_out[1] = -1.0 * fac * rints_buff[4];
    rints_out[11] = -1.0 * fac * rints_buff[7];
    rints_out[21] = -1.0 * fac * rints_buff[8];
    rints_out[31] = -1.0 * fac * rints_buff[9];
    rints_out[2] = -1.0 * fac * rints_buff[5];
    rints_out[12] = -1.0 * fac * rints_buff[8];
    rints_out[22] = -1.0 * fac * rints_buff[10];
    rints_out[32] = -1.0 * fac * rints_buff[11];
    rints_out[3] = -1.0 * fac * rints_buff[6];
    rints_out[13] = -1.0 * fac * rints_buff[9];
    rints_out[23] = -1.0 * fac * rints_buff[11];
    rints_out[33] = -1.0 * fac * rints_buff[12];
    rints_out[4] = 1.0 * fac * rints_buff[7];
    rints_out[14] = 1.0 * fac * rints_buff[13];
    rints_out[24] = 1.0 * fac * rints_buff[14];
    rints_out[34] = 1.0 * fac * rints_buff[15];
    rints_out[5] = 1.0 * fac * rints_buff[8];
    rints_out[15] = 1.0 * fac * rints_buff[14];
    rints_out[25] = 1.0 * fac * rints_buff[16];
    rints_out[35] = 1.0 * fac * rints_buff[17];
    rints_out[6] = 1.0 * fac * rints_buff[9];
    rints_out[16] = 1.0 * fac * rints_buff[15];
    rints_out[26] = 1.0 * fac * rints_buff[17];
    rints_out[36] = 1.0 * fac * rints_buff[18];
    rints_out[7] = 1.0 * fac * rints_buff[10];
    rints_out[17] = 1.0 * fac * rints_buff[16];
    rints_out[27] = 1.0 * fac * rints_buff[19];
    rints_out[37] = 1.0 * fac * rints_buff[20];
    rints_out[8] = 1.0 * fac * rints_buff[11];
    rints_out[18] = 1.0 * fac * rints_buff[17];
    rints_out[28] = 1.0 * fac * rints_buff[20];
    rints_out[38] = 1.0 * fac * rints_buff[21];
    rints_out[9] = 1.0 * fac * rints_buff[12];
    rints_out[19] = 1.0 * fac * rints_buff[18];
    rints_out[29] = 1.0 * fac * rints_buff[21];
    rints_out[39] = 1.0 * fac * rints_buff[22];
}
}

template void lible::ints::calcRInts_ERI2_deriv1<1, 2>(const double, const double, const double*, const double*, double*);
template void lible::ints::calcRInts_ERI2D1<1, 2>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<1, 2>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<1, 2>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<1, 2>(const double alpha, const double fac, const double *fnx,
