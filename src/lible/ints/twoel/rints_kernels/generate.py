...
def writeKernelInstantiate(la, lb):
	...
	file_str += instantiateR_ERISOC(la, lb)
...
def instantiateR_ERISOC(la, lb):

	file_str = 'template void lible::ints::calcRInts_ERISOC<{}, {}>(const double alpha, const double fac, const double *fnx,\n'.format(la, lb)
	file_str += '                                                  const double *xyz_pc, double *rints);\n\n'
