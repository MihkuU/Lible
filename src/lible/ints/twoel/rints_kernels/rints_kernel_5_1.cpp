...
template<>
void lible::ints::calcRInts_ERI_new<5, 1>(const double alpha, const double fac, const double *fnx,
                                          ...
                                          const int ofs_col, double *rints_out)
{
    ...
    rints_out[(ofs_row + 35) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[62];
    rints_out[(ofs_row + 36) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[63];
    rints_out[(ofs_row + 37) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[64];
    rints_out[(ofs_row + 38) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[65];
    rints_out[(ofs_row + 39) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[66];
    rints_out[(ofs_row + 40) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[67];
    rints_out[(ofs_row + 41) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[68];
    rints_out[(ofs_row + 42) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[69];
    rints_out[(ofs_row + 43) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[70];
    rints_out[(ofs_row + 44) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[71];
    rints_out[(ofs_row + 45) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[72];
    rints_out[(ofs_row + 46) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[73];
    rints_out[(ofs_row + 47) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[74];
    rints_out[(ofs_row + 48) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[75];
    rints_out[(ofs_row + 49) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[76];
    rints_out[(ofs_row + 50) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[77];
    rints_out[(ofs_row + 51) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[78];
    rints_out[(ofs_row + 52) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[79];
    rints_out[(ofs_row + 53) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[80];
    rints_out[(ofs_row + 54) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[81];
    rints_out[(ofs_row + 55) * n_cols + (ofs_col + 1)] = -1.0 * fac * rints_buff[82];
    ...
    rints_out[(ofs_row + 35) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[63];
    rints_out[(ofs_row + 36) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[65];
    rints_out[(ofs_row + 37) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[66];
    rints_out[(ofs_row + 38) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[68];
    rints_out[(ofs_row + 39) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[69];
    rints_out[(ofs_row + 40) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[70];
    rints_out[(ofs_row + 41) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[72];
    rints_out[(ofs_row + 42) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[73];
    rints_out[(ofs_row + 43) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[74];
    rints_out[(ofs_row + 44) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[75];
    rints_out[(ofs_row + 45) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[77];
    rints_out[(ofs_row + 46) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[78];
    rints_out[(ofs_row + 47) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[79];
    rints_out[(ofs_row + 48) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[80];
    rints_out[(ofs_row + 49) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[81];
    rints_out[(ofs_row + 50) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[83];
    rints_out[(ofs_row + 51) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[84];
    rints_out[(ofs_row + 52) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[85];
    rints_out[(ofs_row + 53) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[86];
    rints_out[(ofs_row + 54) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[87];
    rints_out[(ofs_row + 55) * n_cols + (ofs_col + 2)] = -1.0 * fac * rints_buff[88];
    ...
    rints_out[(ofs_row + 35) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[64];
    rints_out[(ofs_row + 36) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[66];
    rints_out[(ofs_row + 37) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[67];
    rints_out[(ofs_row + 38) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[69];
    rints_out[(ofs_row + 39) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[70];
    rints_out[(ofs_row + 40) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[71];
    rints_out[(ofs_row + 41) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[73];
    rints_out[(ofs_row + 42) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[74];
    rints_out[(ofs_row + 43) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[75];
    rints_out[(ofs_row + 44) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[76];
    rints_out[(ofs_row + 45) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[78];
    rints_out[(ofs_row + 46) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[79];
    rints_out[(ofs_row + 47) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[80];
    rints_out[(ofs_row + 48) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[81];
    rints_out[(ofs_row + 49) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[82];
    rints_out[(ofs_row + 50) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[84];
    rints_out[(ofs_row + 51) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[85];
    rints_out[(ofs_row + 52) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[86];
    rints_out[(ofs_row + 53) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[87];
    rints_out[(ofs_row + 54) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[88];
    rints_out[(ofs_row + 55) * n_cols + (ofs_col + 3)] = -1.0 * fac * rints_buff[89];
}
...
template<>
void calcRInts_ERI<5, 1>(const double alpha, const double fac, const double *fnx,
...
template void lible::ints::calcRInts_ERI2_deriv1<5, 1>(const double, const double, const double*, const double*, double*);
template void lible::ints::calcRInts_ERI2D1<5, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI2D2<5, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_ab, double *rints);

template void lible::ints::calcRInts_ERI3D1<5, 1>(const double alpha, const double fac, const double *fnx,
                                                  const double *xyz_pc, double *rints);

template void lible::ints::calcRInts_ERI4D1<5, 1>(const double alpha, const double fac, const double *fnx,
