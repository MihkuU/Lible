...
template<> void lible::ints::two::eri3Kernel<0, 0, 1>(const int cdepth_a, const int cdepth_b, const int cdepth_c,
                                                      const double* exps_a, const double* exps_b,
...
template<> void lible::ints::two::eri2Kernel<0, 1>(const int cdepth_a, const int cdepth_b,
                                                   const double* exps_a, const double* exps_b,
                                                   const double* coords_a, const double* coords_b,
