...
template lible::vec4d lible::ints::eri4KernelFun<1, 1, 1, 1>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<1, 1, 1, 1>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<1, 1, 1, 1>(const int ipair_ab, const int ipair_cd,
                                         ...
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[81];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[28];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[82];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[29];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[83];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[30];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[84];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[31];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[85];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[32];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[86];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[33];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[87];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[34];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[88];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[35];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[89];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[27];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[54];
            eri4_batch(0, 1, 0, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[10];
            eri4_batch(0, 1, 0, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 1, 0, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[28];
            eri4_batch(0, 1, 0, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[55];
            eri4_batch(0, 1, 0, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[11];
            eri4_batch(0, 1, 0, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 1, 0, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[29];
            eri4_batch(0, 1, 0, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[56];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[12];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[30];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[57];
            eri4_batch(0, 1, 1, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[13];
            eri4_batch(0, 1, 1, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 1, 1, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[31];
            eri4_batch(0, 1, 1, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[58];
            eri4_batch(0, 1, 1, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[14];
            eri4_batch(0, 1, 1, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 1, 1, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[32];
            eri4_batch(0, 1, 1, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[59];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[15];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[33];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[60];
            eri4_batch(0, 1, 2, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 1, 2, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 1, 2, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[34];
            eri4_batch(0, 1, 2, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[61];
            eri4_batch(0, 1, 2, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 1, 2, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 1, 2, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[35];
            eri4_batch(0, 1, 2, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[62];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[27];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[72];
            eri4_batch(0, 2, 0, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 2, 0, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[28];
            eri4_batch(0, 2, 0, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[19];
            eri4_batch(0, 2, 0, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[73];
            eri4_batch(0, 2, 0, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 2, 0, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[29];
            eri4_batch(0, 2, 0, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[20];
            eri4_batch(0, 2, 0, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[74];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[30];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[21];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[75];
            eri4_batch(0, 2, 1, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 2, 1, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[31];
            eri4_batch(0, 2, 1, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[22];
            eri4_batch(0, 2, 1, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[76];
            eri4_batch(0, 2, 1, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 2, 1, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[32];
            eri4_batch(0, 2, 1, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[23];
            eri4_batch(0, 2, 1, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[77];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[33];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[24];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[78];
            eri4_batch(0, 2, 2, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 2, 2, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[34];
            eri4_batch(0, 2, 2, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[25];
            eri4_batch(0, 2, 2, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[79];
            eri4_batch(0, 2, 2, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 2, 2, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[35];
            eri4_batch(0, 2, 2, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[26];
            eri4_batch(0, 2, 2, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[80];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[27];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[54];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[10];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[28];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[55];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[11];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[29];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[56];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[12];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[30];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[57];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[13];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[31];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[58];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[14];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[32];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[59];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[33];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[60];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[34];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[61];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[35];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[62];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[36];
            eri4_batch(1, 1, 0, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[10];
            eri4_batch(1, 1, 0, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 1, 0, 1) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[37];
            eri4_batch(1, 1, 0, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[11];
            eri4_batch(1, 1, 0, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 1, 0, 2) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[38];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[12];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[39];
            eri4_batch(1, 1, 1, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[13];
            eri4_batch(1, 1, 1, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 1, 1, 1) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[40];
            eri4_batch(1, 1, 1, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[14];
            eri4_batch(1, 1, 1, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 1, 1, 2) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[41];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[42];
            eri4_batch(1, 1, 2, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 1, 2, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 1, 2, 1) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[43];
            eri4_batch(1, 1, 2, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 1, 2, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 1, 2, 2) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[44];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[45];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[18];
            eri4_batch(1, 2, 0, 1) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[10];
            eri4_batch(1, 2, 0, 1) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 2, 0, 1) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[46];
            eri4_batch(1, 2, 0, 1) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[19];
            eri4_batch(1, 2, 0, 2) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[11];
            eri4_batch(1, 2, 0, 2) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 2, 0, 2) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[47];
            eri4_batch(1, 2, 0, 2) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[20];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[12];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[48];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[21];
            eri4_batch(1, 2, 1, 1) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[13];
            eri4_batch(1, 2, 1, 1) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 2, 1, 1) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[49];
            eri4_batch(1, 2, 1, 1) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[22];
            eri4_batch(1, 2, 1, 2) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[14];
            eri4_batch(1, 2, 1, 2) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 2, 1, 2) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[50];
            eri4_batch(1, 2, 1, 2) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[23];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[51];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[24];
            eri4_batch(1, 2, 2, 1) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 2, 2, 1) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 2, 2, 1) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[52];
            eri4_batch(1, 2, 2, 1) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[25];
            eri4_batch(1, 2, 2, 2) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 2, 2, 2) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 2, 2, 2) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[53];
            eri4_batch(1, 2, 2, 2) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[26];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[27];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[72];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[28];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[73];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[29];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[20];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[74];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[30];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[21];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[75];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[31];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[22];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[76];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[32];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[23];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[77];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[33];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[24];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[78];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[34];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[25];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[79];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[35];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[26];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[80];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[9];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[45];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 1, 0, 1) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[10];
            eri4_batch(2, 1, 0, 1) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 1, 0, 1) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[46];
            eri4_batch(2, 1, 0, 1) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 1, 0, 2) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[11];
            eri4_batch(2, 1, 0, 2) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 1, 0, 2) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[47];
            eri4_batch(2, 1, 0, 2) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[20];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[12];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[48];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[21];
            eri4_batch(2, 1, 1, 1) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[13];
            eri4_batch(2, 1, 1, 1) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 1, 1, 1) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[49];
            eri4_batch(2, 1, 1, 1) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[22];
            eri4_batch(2, 1, 1, 2) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[14];
            eri4_batch(2, 1, 1, 2) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 1, 1, 2) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[50];
            eri4_batch(2, 1, 1, 2) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[23];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[15];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[51];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[24];
            eri4_batch(2, 1, 2, 1) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[16];
            eri4_batch(2, 1, 2, 1) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 1, 2, 1) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[52];
            eri4_batch(2, 1, 2, 1) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[25];
            eri4_batch(2, 1, 2, 2) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[17];
            eri4_batch(2, 1, 2, 2) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 1, 2, 2) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[53];
            eri4_batch(2, 1, 2, 2) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[26];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[63];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 2, 0, 1) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[64];
            eri4_batch(2, 2, 0, 1) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 2, 0, 1) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 2, 0, 2) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[65];
            eri4_batch(2, 2, 0, 2) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 2, 0, 2) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[20];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[66];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[21];
            eri4_batch(2, 2, 1, 1) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[67];
            eri4_batch(2, 2, 1, 1) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 2, 1, 1) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[22];
            eri4_batch(2, 2, 1, 2) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[68];
            eri4_batch(2, 2, 1, 2) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 2, 1, 2) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[23];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[69];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[24];
            eri4_batch(2, 2, 2, 1) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[70];
            eri4_batch(2, 2, 2, 1) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 2, 2, 1) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[25];
            eri4_batch(2, 2, 2, 2) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[71];
            eri4_batch(2, 2, 2, 2) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 2, 2, 2) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[26];
        }
...
template lible::vec4d lible::ints::eri4KernelFun<1, 1, 2, 0>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<1, 1, 2, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<1, 1, 0, 2>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<1, 1, 2, 0>(const int ipair_ab, const int ipair_cd,
                                         const std::vector<double> &ecoeffs_ab,
                                         const std::vector<double> &ecoeffs_cd_tsp,
                                         const ShellPairData &sp_data_ab,
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[45];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[46];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[47];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[48];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[19];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[49];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[15];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[30];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 1, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[31];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 1, 2, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[32];
            eri4_batch(0, 1, 3, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 1, 3, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 1, 3, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 1, 3, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[33];
            eri4_batch(0, 1, 4, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri4_batch(0, 1, 4, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 1, 4, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[19];
            eri4_batch(0, 1, 4, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[34];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[15];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[10];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[40];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[11];
            eri4_batch(0, 2, 1, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[41];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[12];
            eri4_batch(0, 2, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[42];
            eri4_batch(0, 2, 3, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 2, 3, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 2, 3, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[13];
            eri4_batch(0, 2, 3, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[43];
            eri4_batch(0, 2, 4, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 2, 4, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[19];
            eri4_batch(0, 2, 4, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[14];
            eri4_batch(0, 2, 4, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[44];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[30];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[31];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[32];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[18];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[33];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[19];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[34];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[20];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 1, 1, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[21];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 1, 2, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[22];
            eri4_batch(1, 1, 3, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 1, 3, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 1, 3, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[23];
            eri4_batch(1, 1, 4, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 1, 4, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 1, 4, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[24];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[25];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[10];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[26];
            eri4_batch(1, 2, 1, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[11];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[27];
            eri4_batch(1, 2, 2, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[12];
            eri4_batch(1, 2, 3, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 2, 3, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 2, 3, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[28];
            eri4_batch(1, 2, 3, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[13];
            eri4_batch(1, 2, 4, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 2, 4, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 2, 4, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[29];
            eri4_batch(1, 2, 4, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[14];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[15];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[10];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[40];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[16];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[11];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[41];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[17];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[12];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[42];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[13];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[43];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[14];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[44];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[25];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[10];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[26];
            eri4_batch(2, 1, 1, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[11];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[27];
            eri4_batch(2, 1, 2, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[12];
            eri4_batch(2, 1, 3, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 1, 3, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 1, 3, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[28];
            eri4_batch(2, 1, 3, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[13];
            eri4_batch(2, 1, 4, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[9];
            eri4_batch(2, 1, 4, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 1, 4, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[29];
            eri4_batch(2, 1, 4, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[14];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[35];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[10];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[36];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 2, 1, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[11];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[37];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 2, 2, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[12];
            eri4_batch(2, 2, 3, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[38];
            eri4_batch(2, 2, 3, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 2, 3, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[13];
            eri4_batch(2, 2, 4, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[39];
            eri4_batch(2, 2, 4, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 2, 4, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[14];
        }
...
template lible::vec4d lible::ints::eri4KernelFun<2, 0, 1, 1>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<2, 0, 1, 1>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<0, 2, 1, 1>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<2, 0, 1, 1>(const int ipair_ab, const int ipair_cd,
                                         const std::vector<double> &ecoeffs_ab,
                                         const std::vector<double> &ecoeffs_cd_tsp,
                                         const ShellPairData &sp_data_ab,
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[63];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[9];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[81];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[36];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[27];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[19];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[64];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[10];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[82];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[37];
            eri4_batch(0, 0, 0, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[28];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[20];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[65];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[11];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[83];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[38];
            eri4_batch(0, 0, 0, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[29];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[21];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[66];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[12];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[84];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[39];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[30];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[22];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[67];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[13];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[85];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[40];
            eri4_batch(0, 0, 1, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[31];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[23];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[68];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[14];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[86];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[41];
            eri4_batch(0, 0, 1, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[32];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[24];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[69];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[15];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[87];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[42];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[33];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[25];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[70];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[88];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[43];
            eri4_batch(0, 0, 2, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[34];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[26];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[71];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[89];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[44];
            eri4_batch(0, 0, 2, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[35];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[27];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[54];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[10];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[28];
            eri4_batch(1, 0, 0, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[55];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[11];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[29];
            eri4_batch(1, 0, 0, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[56];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[12];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[30];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[57];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[13];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[31];
            eri4_batch(1, 0, 1, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[58];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[14];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[32];
            eri4_batch(1, 0, 1, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[59];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[33];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[60];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[34];
            eri4_batch(1, 0, 2, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[61];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[35];
            eri4_batch(1, 0, 2, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[62];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[27];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[72];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[28];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 0, 0, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[73];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[29];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[20];
            eri4_batch(2, 0, 0, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[74];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[30];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[21];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[75];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[31];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[22];
            eri4_batch(2, 0, 1, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[76];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[32];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[23];
            eri4_batch(2, 0, 1, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[77];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[33];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[24];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[78];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[34];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[25];
            eri4_batch(2, 0, 2, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[79];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[35];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[26];
            eri4_batch(2, 0, 2, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[80];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[18];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[63];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[36];
            eri4_batch(3, 0, 0, 1) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[19];
            eri4_batch(3, 0, 0, 1) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[64];
            eri4_batch(3, 0, 0, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri4_batch(3, 0, 0, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[10];
            eri4_batch(3, 0, 0, 1) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[37];
            eri4_batch(3, 0, 0, 2) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[20];
            eri4_batch(3, 0, 0, 2) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[65];
            eri4_batch(3, 0, 0, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri4_batch(3, 0, 0, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[11];
            eri4_batch(3, 0, 0, 2) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[38];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[21];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[66];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[12];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[39];
            eri4_batch(3, 0, 1, 1) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[22];
            eri4_batch(3, 0, 1, 1) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[67];
            eri4_batch(3, 0, 1, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri4_batch(3, 0, 1, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[13];
            eri4_batch(3, 0, 1, 1) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[40];
            eri4_batch(3, 0, 1, 2) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[23];
            eri4_batch(3, 0, 1, 2) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[68];
            eri4_batch(3, 0, 1, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[5];
            eri4_batch(3, 0, 1, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[14];
            eri4_batch(3, 0, 1, 2) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[41];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[24];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[69];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[6];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[15];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[42];
            eri4_batch(3, 0, 2, 1) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[25];
            eri4_batch(3, 0, 2, 1) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[70];
            eri4_batch(3, 0, 2, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[7];
            eri4_batch(3, 0, 2, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[16];
            eri4_batch(3, 0, 2, 1) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[43];
            eri4_batch(3, 0, 2, 2) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[26];
            eri4_batch(3, 0, 2, 2) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[71];
            eri4_batch(3, 0, 2, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[8];
            eri4_batch(3, 0, 2, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[17];
            eri4_batch(3, 0, 2, 2) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[44];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[45];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[18];
            eri4_batch(4, 0, 0, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[10];
            eri4_batch(4, 0, 0, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri4_batch(4, 0, 0, 1) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[46];
            eri4_batch(4, 0, 0, 1) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[19];
            eri4_batch(4, 0, 0, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[11];
            eri4_batch(4, 0, 0, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri4_batch(4, 0, 0, 2) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[47];
            eri4_batch(4, 0, 0, 2) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[20];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[12];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[48];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[21];
            eri4_batch(4, 0, 1, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[13];
            eri4_batch(4, 0, 1, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri4_batch(4, 0, 1, 1) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[49];
            eri4_batch(4, 0, 1, 1) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[22];
            eri4_batch(4, 0, 1, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[14];
            eri4_batch(4, 0, 1, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[5];
            eri4_batch(4, 0, 1, 2) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[50];
            eri4_batch(4, 0, 1, 2) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[23];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[15];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[6];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[51];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[24];
            eri4_batch(4, 0, 2, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[16];
            eri4_batch(4, 0, 2, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[7];
            eri4_batch(4, 0, 2, 1) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[52];
            eri4_batch(4, 0, 2, 1) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[25];
            eri4_batch(4, 0, 2, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[17];
            eri4_batch(4, 0, 2, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[8];
            eri4_batch(4, 0, 2, 2) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[53];
            eri4_batch(4, 0, 2, 2) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[26];
        }
...
template lible::vec4d lible::ints::eri4KernelFun<2, 0, 2, 0>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<2, 0, 2, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<0, 2, 0, 2>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<0, 2, 2, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<2, 0, 0, 2>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<2, 0, 2, 0>(const int ipair_ab, const int ipair_cd,
                                         const std::vector<double> &ecoeffs_ab,
                                         const std::vector<double> &ecoeffs_cd_tsp,
                                         const ShellPairData &sp_data_ab,
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[10];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[35];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[5];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[45];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[20];
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[15];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[11];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[36];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[46];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[21];
            eri4_batch(0, 0, 1, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[16];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[12];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[37];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[7];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[47];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[22];
            eri4_batch(0, 0, 2, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[17];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[13];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[38];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[8];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[48];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[23];
            eri4_batch(0, 0, 3, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[18];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[14];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[39];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[9];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[49];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[24];
            eri4_batch(0, 0, 4, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[19];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[15];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[30];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[16];
            eri4_batch(1, 0, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[31];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[7];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[17];
            eri4_batch(1, 0, 2, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[32];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[18];
            eri4_batch(1, 0, 3, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[33];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[19];
            eri4_batch(1, 0, 4, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[34];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[15];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[10];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[40];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[16];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[11];
            eri4_batch(2, 0, 1, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[41];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[17];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[12];
            eri4_batch(2, 0, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[42];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[18];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[13];
            eri4_batch(2, 0, 3, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[43];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[19];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[14];
            eri4_batch(2, 0, 4, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[44];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[10];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[35];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[5];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[20];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[11];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[36];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[6];
            eri4_batch(3, 0, 1, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[21];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[12];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[37];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[7];
            eri4_batch(3, 0, 2, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[22];
            eri4_batch(3, 0, 3, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[13];
            eri4_batch(3, 0, 3, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[38];
            eri4_batch(3, 0, 3, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri4_batch(3, 0, 3, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[8];
            eri4_batch(3, 0, 3, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[23];
            eri4_batch(3, 0, 4, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[14];
            eri4_batch(3, 0, 4, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[39];
            eri4_batch(3, 0, 4, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri4_batch(3, 0, 4, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri4_batch(3, 0, 4, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[24];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[5];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[25];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[10];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[6];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[26];
            eri4_batch(4, 0, 1, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[11];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[7];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[27];
            eri4_batch(4, 0, 2, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[12];
            eri4_batch(4, 0, 3, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[8];
            eri4_batch(4, 0, 3, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri4_batch(4, 0, 3, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[28];
            eri4_batch(4, 0, 3, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[13];
            eri4_batch(4, 0, 4, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri4_batch(4, 0, 4, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri4_batch(4, 0, 4, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[29];
            eri4_batch(4, 0, 4, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[14];
        }
...
template lible::vec3d lible::ints::eri3KernelFun<1, 1, 2>(const int ipair_ab, const int ishell_c,
                                                          const ShellPairData &sp_data_ab,
                                                          const ShellData &sh_data_c,
                                                          const ERI3Kernel *eri3_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<1, 1, 2>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template<> lible::vec3d
lible::ints::two::eri3Kernel<1, 1, 2>(const int ipair_ab, const int ishell_c,
                                      const std::vector<double> &ecoeffs_ab,
                                      ...
                                      const ShellData &sh_data_c)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[45];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[16];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[46];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[17];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[47];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[18];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[48];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[19];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[49];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[5];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[15];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[30];
            eri3_batch(0, 1, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[6];
            eri3_batch(0, 1, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri3_batch(0, 1, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[16];
            eri3_batch(0, 1, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[31];
            eri3_batch(0, 1, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[7];
            eri3_batch(0, 1, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri3_batch(0, 1, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[17];
            eri3_batch(0, 1, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[32];
            eri3_batch(0, 1, 3) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[8];
            eri3_batch(0, 1, 3) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 1, 3) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[18];
            eri3_batch(0, 1, 3) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[33];
            eri3_batch(0, 1, 4) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri3_batch(0, 1, 4) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri3_batch(0, 1, 4) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[19];
            eri3_batch(0, 1, 4) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[34];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[15];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[10];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[40];
            eri3_batch(0, 2, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri3_batch(0, 2, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[16];
            eri3_batch(0, 2, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[11];
            eri3_batch(0, 2, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[41];
            eri3_batch(0, 2, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri3_batch(0, 2, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[17];
            eri3_batch(0, 2, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[12];
            eri3_batch(0, 2, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[42];
            eri3_batch(0, 2, 3) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 2, 3) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[18];
            eri3_batch(0, 2, 3) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[13];
            eri3_batch(0, 2, 3) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[43];
            eri3_batch(0, 2, 4) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri3_batch(0, 2, 4) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[19];
            eri3_batch(0, 2, 4) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[14];
            eri3_batch(0, 2, 4) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[44];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[5];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[15];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[30];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[6];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[16];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[31];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[7];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[17];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[32];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[8];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[18];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[33];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[19];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[34];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[5];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[20];
            eri3_batch(1, 1, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[6];
            eri3_batch(1, 1, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 1, 1) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[21];
            eri3_batch(1, 1, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[7];
            eri3_batch(1, 1, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri3_batch(1, 1, 2) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[22];
            eri3_batch(1, 1, 3) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[8];
            eri3_batch(1, 1, 3) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 1, 3) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[23];
            eri3_batch(1, 1, 4) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri3_batch(1, 1, 4) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri3_batch(1, 1, 4) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[24];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[5];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[25];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[10];
            eri3_batch(1, 2, 1) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[6];
            eri3_batch(1, 2, 1) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 2, 1) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[26];
            eri3_batch(1, 2, 1) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[11];
            eri3_batch(1, 2, 2) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[7];
            eri3_batch(1, 2, 2) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[2];
            eri3_batch(1, 2, 2) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[27];
            eri3_batch(1, 2, 2) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[12];
            eri3_batch(1, 2, 3) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[8];
            eri3_batch(1, 2, 3) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 2, 3) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[28];
            eri3_batch(1, 2, 3) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[13];
            eri3_batch(1, 2, 4) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[9];
            eri3_batch(1, 2, 4) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[4];
            eri3_batch(1, 2, 4) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[29];
            eri3_batch(1, 2, 4) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[14];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[15];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[10];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[40];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[1];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[16];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[11];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[41];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[17];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[12];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[42];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[18];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[13];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[43];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[4];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[19];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[14];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[44];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[5];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[25];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[10];
            eri3_batch(2, 1, 1) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[6];
            eri3_batch(2, 1, 1) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[1];
            eri3_batch(2, 1, 1) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[26];
            eri3_batch(2, 1, 1) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[11];
            eri3_batch(2, 1, 2) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[7];
            eri3_batch(2, 1, 2) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 1, 2) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[27];
            eri3_batch(2, 1, 2) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[12];
            eri3_batch(2, 1, 3) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[8];
            eri3_batch(2, 1, 3) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 1, 3) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[28];
            eri3_batch(2, 1, 3) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[13];
            eri3_batch(2, 1, 4) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[9];
            eri3_batch(2, 1, 4) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[4];
            eri3_batch(2, 1, 4) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[29];
            eri3_batch(2, 1, 4) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[14];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[35];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[10];
            eri3_batch(2, 2, 1) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[36];
            eri3_batch(2, 2, 1) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[1];
            eri3_batch(2, 2, 1) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[11];
            eri3_batch(2, 2, 2) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[37];
            eri3_batch(2, 2, 2) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 2, 2) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[12];
            eri3_batch(2, 2, 3) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[38];
            eri3_batch(2, 2, 3) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 2, 3) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[13];
            eri3_batch(2, 2, 4) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[39];
            eri3_batch(2, 2, 4) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[4];
            eri3_batch(2, 2, 4) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[14];
        }
...
template lible::vec3d lible::ints::eri3KernelFun<2, 0, 2>(const int ipair_ab, const int ishell_c,
                                                          const ShellPairData &sp_data_ab,
                                                          const ShellData &sh_data_c,
                                                          const ERI3Kernel *eri3_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<2, 0, 2>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<0, 2, 2>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template<> lible::vec3d
lible::ints::two::eri3Kernel<2, 0, 2>(const int ipair_ab, const int ishell_c,
                                      const std::vector<double> &ecoeffs_ab,
                                      const std::vector<double> &ecoeffs_c,
                                      const ShellPairData &sp_data_ab,
                                      const ShellData &sh_data_c)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[10];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[35];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[0];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[5];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[45];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[20];
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[15];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[11];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[36];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[1];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[6];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[46];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[21];
            eri3_batch(0, 0, 1) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[16];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[12];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[37];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[2];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[7];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[47];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[22];
            eri3_batch(0, 0, 2) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[17];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[13];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[38];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[8];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[48];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[23];
            eri3_batch(0, 0, 3) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[18];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[2] * p_rints_x_ecoeffs[14];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[7] * p_rints_x_ecoeffs[39];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[0] * p_rints_x_ecoeffs[4];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[1] * p_rints_x_ecoeffs[9];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[9] * p_rints_x_ecoeffs[49];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[4] * p_rints_x_ecoeffs[24];
            eri3_batch(0, 0, 4) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[19];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[5];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[15];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[30];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[6];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[16];
            eri3_batch(1, 0, 1) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[31];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[7];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[2];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[17];
            eri3_batch(1, 0, 2) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[32];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[8];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[18];
            eri3_batch(1, 0, 3) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[33];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[9];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[4];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[19];
            eri3_batch(1, 0, 4) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[34];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[15];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[10];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[40];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[1];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[16];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[11];
            eri3_batch(2, 0, 1) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[41];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[17];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[12];
            eri3_batch(2, 0, 2) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[42];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[18];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[13];
            eri3_batch(2, 0, 3) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[43];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[4];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[19];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[14];
            eri3_batch(2, 0, 4) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[44];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[10];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[35];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[5];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[20];
            eri3_batch(3, 0, 1) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[11];
            eri3_batch(3, 0, 1) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[36];
            eri3_batch(3, 0, 1) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[1];
            eri3_batch(3, 0, 1) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[6];
            eri3_batch(3, 0, 1) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[21];
            eri3_batch(3, 0, 2) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[12];
            eri3_batch(3, 0, 2) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[37];
            eri3_batch(3, 0, 2) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[2];
            eri3_batch(3, 0, 2) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[7];
            eri3_batch(3, 0, 2) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[22];
            eri3_batch(3, 0, 3) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[13];
            eri3_batch(3, 0, 3) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[38];
            eri3_batch(3, 0, 3) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[3];
            eri3_batch(3, 0, 3) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[8];
            eri3_batch(3, 0, 3) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[23];
            eri3_batch(3, 0, 4) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[14];
            eri3_batch(3, 0, 4) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[39];
            eri3_batch(3, 0, 4) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[4];
            eri3_batch(3, 0, 4) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[9];
            eri3_batch(3, 0, 4) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[24];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[5];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[25];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[10];
            eri3_batch(4, 0, 1) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[6];
            eri3_batch(4, 0, 1) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[1];
            eri3_batch(4, 0, 1) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[26];
            eri3_batch(4, 0, 1) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[11];
            eri3_batch(4, 0, 2) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[7];
            eri3_batch(4, 0, 2) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[2];
            eri3_batch(4, 0, 2) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[27];
            eri3_batch(4, 0, 2) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[12];
            eri3_batch(4, 0, 3) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[8];
            eri3_batch(4, 0, 3) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[3];
            eri3_batch(4, 0, 3) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[28];
            eri3_batch(4, 0, 3) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[13];
            eri3_batch(4, 0, 4) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[9];
            eri3_batch(4, 0, 4) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[4];
            eri3_batch(4, 0, 4) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[29];
            eri3_batch(4, 0, 4) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[14];
        }
...
template lible::vec2d lible::ints::eri2KernelFun<2, 2>(const int ishell_a, const int ishell_b,
                                                       const ShellData &sh_data_a,
                                                       const ShellData &sh_data_b,
                                                       const ERI2Kernel *eri2_kernel);

template std::array<lible::vec2d, 6> lible::ints::eri2d1KernelFun<2, 2>(const int ishell_a, const int ishell_b,
                                                                        const ShellData &sh_data_a,
                                                                        const ShellData &sh_data_b,
                                                                        const ERI2D1Kernel *eri2d1_kernel);

template<> lible::vec2d
lible::ints::two::eri2Kernel<2, 2>(const int ishell_a, const int ishell_b,
                                   ...
                                   const ShellData &sh_data_a, const ShellData &sh_data_b)
{
    ...
    for (int ia = 0; ia < cdepth_a; ia++)
    {
        ...
        eri2_batch(0, 0) += p_ecoeffs_a[2] * p_rints_x_ecoeffs[10];
        eri2_batch(0, 0) += p_ecoeffs_a[7] * p_rints_x_ecoeffs[35];
        eri2_batch(0, 0) += p_ecoeffs_a[0] * p_rints_x_ecoeffs[0];
        eri2_batch(0, 0) += p_ecoeffs_a[1] * p_rints_x_ecoeffs[5];
        eri2_batch(0, 0) += p_ecoeffs_a[9] * p_rints_x_ecoeffs[45];
        eri2_batch(0, 0) += p_ecoeffs_a[4] * p_rints_x_ecoeffs[20];
        eri2_batch(0, 0) += p_ecoeffs_a[3] * p_rints_x_ecoeffs[15];
        eri2_batch(0, 1) += p_ecoeffs_a[2] * p_rints_x_ecoeffs[11];
        eri2_batch(0, 1) += p_ecoeffs_a[7] * p_rints_x_ecoeffs[36];
        eri2_batch(0, 1) += p_ecoeffs_a[0] * p_rints_x_ecoeffs[1];
        eri2_batch(0, 1) += p_ecoeffs_a[1] * p_rints_x_ecoeffs[6];
        eri2_batch(0, 1) += p_ecoeffs_a[9] * p_rints_x_ecoeffs[46];
        eri2_batch(0, 1) += p_ecoeffs_a[4] * p_rints_x_ecoeffs[21];
        eri2_batch(0, 1) += p_ecoeffs_a[3] * p_rints_x_ecoeffs[16];
        eri2_batch(0, 2) += p_ecoeffs_a[2] * p_rints_x_ecoeffs[12];
        eri2_batch(0, 2) += p_ecoeffs_a[7] * p_rints_x_ecoeffs[37];
        eri2_batch(0, 2) += p_ecoeffs_a[0] * p_rints_x_ecoeffs[2];
        eri2_batch(0, 2) += p_ecoeffs_a[1] * p_rints_x_ecoeffs[7];
        eri2_batch(0, 2) += p_ecoeffs_a[9] * p_rints_x_ecoeffs[47];
        eri2_batch(0, 2) += p_ecoeffs_a[4] * p_rints_x_ecoeffs[22];
        eri2_batch(0, 2) += p_ecoeffs_a[3] * p_rints_x_ecoeffs[17];
        eri2_batch(0, 3) += p_ecoeffs_a[2] * p_rints_x_ecoeffs[13];
        eri2_batch(0, 3) += p_ecoeffs_a[7] * p_rints_x_ecoeffs[38];
        eri2_batch(0, 3) += p_ecoeffs_a[0] * p_rints_x_ecoeffs[3];
        eri2_batch(0, 3) += p_ecoeffs_a[1] * p_rints_x_ecoeffs[8];
        eri2_batch(0, 3) += p_ecoeffs_a[9] * p_rints_x_ecoeffs[48];
        eri2_batch(0, 3) += p_ecoeffs_a[4] * p_rints_x_ecoeffs[23];
        eri2_batch(0, 3) += p_ecoeffs_a[3] * p_rints_x_ecoeffs[18];
        eri2_batch(0, 4) += p_ecoeffs_a[2] * p_rints_x_ecoeffs[14];
        eri2_batch(0, 4) += p_ecoeffs_a[7] * p_rints_x_ecoeffs[39];
        eri2_batch(0, 4) += p_ecoeffs_a[0] * p_rints_x_ecoeffs[4];
        eri2_batch(0, 4) += p_ecoeffs_a[1] * p_rints_x_ecoeffs[9];
        eri2_batch(0, 4) += p_ecoeffs_a[9] * p_rints_x_ecoeffs[49];
        eri2_batch(0, 4) += p_ecoeffs_a[4] * p_rints_x_ecoeffs[24];
        eri2_batch(0, 4) += p_ecoeffs_a[3] * p_rints_x_ecoeffs[19];
        eri2_batch(1, 0) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[5];
        eri2_batch(1, 0) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[0];
        eri2_batch(1, 0) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[15];
        eri2_batch(1, 0) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[30];
        eri2_batch(1, 1) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[6];
        eri2_batch(1, 1) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[1];
        eri2_batch(1, 1) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[16];
        eri2_batch(1, 1) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[31];
        eri2_batch(1, 2) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[7];
        eri2_batch(1, 2) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[2];
        eri2_batch(1, 2) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[17];
        eri2_batch(1, 2) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[32];
        eri2_batch(1, 3) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[8];
        eri2_batch(1, 3) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[3];
        eri2_batch(1, 3) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[18];
        eri2_batch(1, 3) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[33];
        eri2_batch(1, 4) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[9];
        eri2_batch(1, 4) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[4];
        eri2_batch(1, 4) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[19];
        eri2_batch(1, 4) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[34];
        eri2_batch(2, 0) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[0];
        eri2_batch(2, 0) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[15];
        eri2_batch(2, 0) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[10];
        eri2_batch(2, 0) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[40];
        eri2_batch(2, 1) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[1];
        eri2_batch(2, 1) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[16];
        eri2_batch(2, 1) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[11];
        eri2_batch(2, 1) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[41];
        eri2_batch(2, 2) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[2];
        eri2_batch(2, 2) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[17];
        eri2_batch(2, 2) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[12];
        eri2_batch(2, 2) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[42];
        eri2_batch(2, 3) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[3];
        eri2_batch(2, 3) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[18];
        eri2_batch(2, 3) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[13];
        eri2_batch(2, 3) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[43];
        eri2_batch(2, 4) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[4];
        eri2_batch(2, 4) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[19];
        eri2_batch(2, 4) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[14];
        eri2_batch(2, 4) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[44];
        eri2_batch(3, 0) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[10];
        eri2_batch(3, 0) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[35];
        eri2_batch(3, 0) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[0];
        eri2_batch(3, 0) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[5];
        eri2_batch(3, 0) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[20];
        eri2_batch(3, 1) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[11];
        eri2_batch(3, 1) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[36];
        eri2_batch(3, 1) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[1];
        eri2_batch(3, 1) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[6];
        eri2_batch(3, 1) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[21];
        eri2_batch(3, 2) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[12];
        eri2_batch(3, 2) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[37];
        eri2_batch(3, 2) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[2];
        eri2_batch(3, 2) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[7];
        eri2_batch(3, 2) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[22];
        eri2_batch(3, 3) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[13];
        eri2_batch(3, 3) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[38];
        eri2_batch(3, 3) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[3];
        eri2_batch(3, 3) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[8];
        eri2_batch(3, 3) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[23];
        eri2_batch(3, 4) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[14];
        eri2_batch(3, 4) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[39];
        eri2_batch(3, 4) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[4];
        eri2_batch(3, 4) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[9];
        eri2_batch(3, 4) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[24];
        eri2_batch(4, 0) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[5];
        eri2_batch(4, 0) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[0];
        eri2_batch(4, 0) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[25];
        eri2_batch(4, 0) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[10];
        eri2_batch(4, 1) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[6];
        eri2_batch(4, 1) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[1];
        eri2_batch(4, 1) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[26];
        eri2_batch(4, 1) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[11];
        eri2_batch(4, 2) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[7];
        eri2_batch(4, 2) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[2];
        eri2_batch(4, 2) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[27];
        eri2_batch(4, 2) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[12];
        eri2_batch(4, 3) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[8];
        eri2_batch(4, 3) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[3];
        eri2_batch(4, 3) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[28];
        eri2_batch(4, 3) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[13];
        eri2_batch(4, 4) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[9];
        eri2_batch(4, 4) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[4];
        eri2_batch(4, 4) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[29];
        eri2_batch(4, 4) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[14];
    }
...
template std::array<lible::vec2d, 6> lible::ints::two::eri2d1Kernel<2, 2>(const int ishell_a, const int ishell_b,
                                                           const std::vector<double> &ecoeffs_a,
                                                           const std::vector<double> &ecoeffs_b_tsp,
                                                           const ShellData &sh_data_a,
                                                           const ShellData &sh_data_b);
