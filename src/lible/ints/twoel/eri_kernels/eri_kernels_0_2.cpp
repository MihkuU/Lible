...
lible::ints::two::eri4Kernel<0, 0, 1, 1>(const int ipair_ab, const int ipair_cd,
...
template<> lible::vec4d
lible::ints::two::eri4Kernel<0, 0, 2, 0>(const int ipair_ab, const int ipair_cd,
                                         const std::vector<double> &ecoeffs_ab,
                                         const std::vector<double> &ecoeffs_cd_tsp,
                                         const ShellPairData &sp_data_ab,
                                         const ShellPairData &sp_data_cd)
...
lible::ints::two::eri3Kernel<0, 0, 2>(const int ipair_ab, const int ishell_c,
                                      const std::vector<double> &ecoeffs_ab,
...
lible::ints::two::eri2Kernel<0, 2>(const int ishell_a, const int ishell_b,
...
template std::array<lible::vec2d, 6> lible::ints::two::eri2d1Kernel<0, 2>(const int ishell_a, const int ishell_b,
                                                           const std::vector<double> &ecoeffs_a,
                                                           const std::vector<double> &ecoeffs_b_tsp,
                                                           const ShellData &sh_data_a,
                                                           const ShellData &sh_data_b);
