...
template lible::vec4d lible::ints::eri4KernelFun<1, 1, 0, 0>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<1, 1, 0, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<1, 1, 0, 0>(const int ipair_ab, const int ipair_cd,
                                         ...
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[1];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 1, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[6];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[3];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[2];
            eri4_batch(0, 2, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[8];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[6];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 1, 0, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[4];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[5];
            eri4_batch(1, 2, 0, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[8];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[1];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[5];
            eri4_batch(2, 1, 0, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[7];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 2, 0, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[2];
        }
...
template lible::vec4d lible::ints::eri4KernelFun<2, 0, 0, 0>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<2, 0, 0, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template std::array<lible::vec4d, 12> lible::ints::eri4d1KernelFun<0, 2, 0, 0>(const int ipair_ab, const int ipair_cd,
                                                                               const ShellPairData &sh_data_ab,
                                                                               const ShellPairData &sp_data_cd,
                                                                               const ERI4D1Kernel *eri4d1_kernel);

template<> lible::vec4d
lible::ints::two::eri4Kernel<2, 0, 0, 0>(const int ipair_ab, const int ipair_cd,
                                         const std::vector<double> &ecoeffs_ab,
                                         const std::vector<double> &ecoeffs_cd_tsp,
                                         const ShellPairData &sp_data_ab,
                                         const ShellPairData &sp_data_cd)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri4_batch(0, 0, 0, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[1];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[3];
            eri4_batch(1, 0, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[6];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[3];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[2];
            eri4_batch(2, 0, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[8];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[2];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[7];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[1];
            eri4_batch(3, 0, 0, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[4];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[1];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[5];
            eri4_batch(4, 0, 0, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[2];
        }
...
template lible::vec3d lible::ints::eri3KernelFun<1, 1, 0>(const int ipair_ab, const int ishell_c,
                                                          const ShellPairData &sp_data_ab,
                                                          const ShellData &sh_data_c,
                                                          const ERI3Kernel *eri3_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<1, 1, 0>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template<> lible::vec3d
lible::ints::two::eri3Kernel<1, 1, 0>(const int ipair_ab, const int ishell_c,
                                      const std::vector<double> &ecoeffs_ab,
                                      ...
                                      const ShellData &sh_data_c)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[1];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 1, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[6];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[3];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[2];
            eri3_batch(0, 2, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[8];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[33] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[36] * p_rints_x_ecoeffs[6];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 1, 0) += p_ecoeffs_ab[44] * p_rints_x_ecoeffs[4];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[51] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[50] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[55] * p_rints_x_ecoeffs[5];
            eri3_batch(1, 2, 0) += p_ecoeffs_ab[52] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[60] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[63] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[62] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[68] * p_rints_x_ecoeffs[8];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[71] * p_rints_x_ecoeffs[1];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[70] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[75] * p_rints_x_ecoeffs[5];
            eri3_batch(2, 1, 0) += p_ecoeffs_ab[72] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[87] * p_rints_x_ecoeffs[7];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[80] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 2, 0) += p_ecoeffs_ab[82] * p_rints_x_ecoeffs[2];
        }
...
template lible::vec3d lible::ints::eri3KernelFun<2, 0, 0>(const int ipair_ab, const int ishell_c,
                                                          const ShellPairData &sp_data_ab,
                                                          const ShellData &sh_data_c,
                                                          const ERI3Kernel *eri3_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<2, 0, 0>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template std::array<lible::vec3d, 9> lible::ints::eri3d1KernelFun<0, 2, 0>(const int ipair_ab, const int ishell_c,
                                                                           const ShellPairData &sh_data_ab,
                                                                           const ShellData &sh_data_c,
                                                                           const ERI3D1Kernel *eri3d1_kernel);

template<> lible::vec3d
lible::ints::two::eri3Kernel<2, 0, 0>(const int ipair_ab, const int ishell_c,
                                      const std::vector<double> &ecoeffs_ab,
                                      const std::vector<double> &ecoeffs_c,
                                      const ShellPairData &sp_data_ab,
                                      const ShellData &sh_data_c)
{
    ...
    for (int ia = 0, iab = 0; ia < cdepth_a; ia++)
        for (int ib = 0; ib < cdepth_b; ib++, iab++)
        {
            ...
            eri3_batch(0, 0, 0) += p_ecoeffs_ab[3] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[11] * p_rints_x_ecoeffs[1];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[10] * p_rints_x_ecoeffs[0];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[13] * p_rints_x_ecoeffs[3];
            eri3_batch(1, 0, 0) += p_ecoeffs_ab[16] * p_rints_x_ecoeffs[6];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[20] * p_rints_x_ecoeffs[0];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[23] * p_rints_x_ecoeffs[3];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[22] * p_rints_x_ecoeffs[2];
            eri3_batch(2, 0, 0) += p_ecoeffs_ab[28] * p_rints_x_ecoeffs[8];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[32] * p_rints_x_ecoeffs[2];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[37] * p_rints_x_ecoeffs[7];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[30] * p_rints_x_ecoeffs[0];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[31] * p_rints_x_ecoeffs[1];
            eri3_batch(3, 0, 0) += p_ecoeffs_ab[34] * p_rints_x_ecoeffs[4];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[41] * p_rints_x_ecoeffs[1];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[40] * p_rints_x_ecoeffs[0];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[45] * p_rints_x_ecoeffs[5];
            eri3_batch(4, 0, 0) += p_ecoeffs_ab[42] * p_rints_x_ecoeffs[2];
        }
...
template lible::vec2d lible::ints::eri2KernelFun<2, 0>(const int ishell_a, const int ishell_b,
                                                       const ShellData &sh_data_a,
                                                       const ShellData &sh_data_b,
                                                       const ERI2Kernel *eri2_kernel);

template std::array<lible::vec2d, 6> lible::ints::eri2d1KernelFun<2, 0>(const int ishell_a, const int ishell_b,
                                                                        const ShellData &sh_data_a,
                                                                        const ShellData &sh_data_b,
                                                                        const ERI2D1Kernel *eri2d1_kernel);

template<> lible::vec2d
lible::ints::two::eri2Kernel<2, 0>(const int ishell_a, const int ishell_b,
                                   ...
                                   const ShellData &sh_data_a, const ShellData &sh_data_b)
{
    ...
    for (int ia = 0; ia < cdepth_a; ia++)
    {
        ...
        eri2_batch(1, 0) += p_ecoeffs_a[11] * p_rints_x_ecoeffs[1];
        eri2_batch(1, 0) += p_ecoeffs_a[10] * p_rints_x_ecoeffs[0];
        eri2_batch(1, 0) += p_ecoeffs_a[13] * p_rints_x_ecoeffs[3];
        eri2_batch(1, 0) += p_ecoeffs_a[16] * p_rints_x_ecoeffs[6];
        eri2_batch(2, 0) += p_ecoeffs_a[20] * p_rints_x_ecoeffs[0];
        eri2_batch(2, 0) += p_ecoeffs_a[23] * p_rints_x_ecoeffs[3];
        eri2_batch(2, 0) += p_ecoeffs_a[22] * p_rints_x_ecoeffs[2];
        eri2_batch(2, 0) += p_ecoeffs_a[28] * p_rints_x_ecoeffs[8];
        eri2_batch(3, 0) += p_ecoeffs_a[32] * p_rints_x_ecoeffs[2];
        eri2_batch(3, 0) += p_ecoeffs_a[37] * p_rints_x_ecoeffs[7];
        eri2_batch(3, 0) += p_ecoeffs_a[30] * p_rints_x_ecoeffs[0];
        eri2_batch(3, 0) += p_ecoeffs_a[31] * p_rints_x_ecoeffs[1];
        eri2_batch(3, 0) += p_ecoeffs_a[34] * p_rints_x_ecoeffs[4];
        eri2_batch(4, 0) += p_ecoeffs_a[41] * p_rints_x_ecoeffs[1];
        eri2_batch(4, 0) += p_ecoeffs_a[40] * p_rints_x_ecoeffs[0];
        eri2_batch(4, 0) += p_ecoeffs_a[45] * p_rints_x_ecoeffs[5];
        eri2_batch(4, 0) += p_ecoeffs_a[42] * p_rints_x_ecoeffs[2];
    }
...
template std::array<lible::vec2d, 6> lible::ints::two::eri2d1Kernel<2, 0>(const int ishell_a, const int ishell_b,
                                                           const std::vector<double> &ecoeffs_a,
                                                           const std::vector<double> &ecoeffs_b_tsp,
                                                           const ShellData &sh_data_a,
                                                           const ShellData &sh_data_b);
