...
template std::array<lible::vec4d, 3> lible::ints::eri4socKernelFun<0, 0, 2, 2>(const int ipair_ab, const int ipair_cd,
                                                                                const ShellPairData &sh_data_ab,
                                                                                const ShellPairData &sp_data_cd,
...
template std::array<lible::vec4d, 3> lible::ints::eri4socKernelFun<0, 0, 3, 1>(const int ipair_ab, const int ipair_cd,
                                                                                const ShellPairData &sh_data_ab,
                                                                                const ShellPairData &sp_data_cd,
                                                                                const ERI4SOCKernel *eri4soc_kernel);

template lible::vec4d lible::ints::eri4KernelFun<0, 0, 1, 3>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);
...
template std::array<lible::vec4d, 3> lible::ints::eri4socKernelFun<0, 0, 1, 3>(const int ipair_ab, const int ipair_cd,
                                                                                const ShellPairData &sh_data_ab,
                                                                                const ShellPairData &sp_data_cd,
                                                                                const ERI4SOCKernel *eri4soc_kernel);
...
template std::array<lible::vec4d, 3> lible::ints::eri4socKernelFun<0, 0, 4, 0>(const int ipair_ab, const int ipair_cd,
                                                                                const ShellPairData &sh_data_ab,
                                                                                const ShellPairData &sp_data_cd,
                                                                                const ERI4SOCKernel *eri4soc_kernel);

template lible::vec4d lible::ints::eri4KernelFun<0, 0, 0, 4>(const int ipair_ab, const int ipair_cd,
                                                             const ShellPairData &sp_data_ab,
                                                             const ShellPairData &sp_data_cd,
                                                             const ERI4Kernel *eri4_kernel);
...
template std::array<lible::vec4d, 3> lible::ints::eri4socKernelFun<0, 0, 0, 4>(const int ipair_ab, const int ipair_cd,
                                                                                const ShellPairData &sh_data_ab,
                                                                                const ShellPairData &sp_data_cd,
                                                                                const ERI4SOCKernel *eri4soc_kernel);
...
lible::ints::eri3d2KernelFun<0, 0, 4>(const int ipair_ab, const int ishell_c,
                                      const ShellPairData &sh_data_ab,
                                      const ShellData &sh_data_c,
                                      const ERI3D2Kernel *eri3d2_kernel);

template std::array<lible::vec3d, 3> lible::ints::eri3socKernelFun<0, 0, 4>(const int ipair_ab, const int ishell_c,
                                                                            const ShellPairData &sh_data_ab,
                                                                            const ShellData &sh_data_c,
...
lible::ints::eri2d2KernelFun<0, 4>(const int ishell_a, const int ishell_b,
                                   const ShellData &sh_data_a,
                                   const ShellData &sh_data_b,
