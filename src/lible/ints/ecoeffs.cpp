...
// void LI::ecoeffsRecurrence2_old(const double a, const double b, const double PA, const double PB,
...
// void LI::ecoeffsPrimitive_old(const double a, const int l, vec2d &ecoeffs_x, vec2d &ecoeffs_y,
//                               vec2d &ecoeffs_z)
// {
//     ecoeffs_x.set(0);
//     ecoeffs_y.set(0);
...
// void LI::ecoeffsPrimitivePair_old(const double a, const double b, const int la, const int lb,
...
//     ecoeffsRecurrence2_old(a, b, xyz_pa[0], xyz_pb[0], one_o_2p, la, lb, ecoeffs_x);
//     ecoeffsRecurrence2_old(a, b, xyz_pa[1], xyz_pb[1], one_o_2p, la, lb, ecoeffs_y);
//     ecoeffsRecurrence2_old(a, b, xyz_pa[2], xyz_pb[2], one_o_2p, la, lb, ecoeffs_z);
// }
...
//             ecoeffsPrimitivePair_old(a, b, l, l, xyz_a, xyz_a, Kab, ecoeffs_x, ecoeffs_y, ecoeffs_z);
...
//                 ecoeffsPrimitivePair_old(a, b, la, lb, xyz_a, xyz_b, Kab, Ex, Ey, Ez);
...
// void LI::ecoeffsShellPairs4D(const int la, const int lb, const int t_max,
...
//         vector<vec4d> ecoeffs_pair(dim_a * dim_b, vec4d(3, la + 1, lb + 1, t_max + 1, 0));
//         for (int ia = 0, iab = 0; ia < dim_a; ia++)
//             for (int ib = 0; ib < dim_b; ib++, iab++)
//             {
//                 double a = sp_data.exps[pos_a + ia];
...
//             ecoeffsPrimitive_old(a, l, ecoeffs_x, ecoeffs_y, ecoeffs_z);
